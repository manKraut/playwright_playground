...
def test_case_id_20(playwright: Playwright) -> None:
    ...
    assert r1_afm_gemh_inDate  == "ΑΦΜ: 094191788 | ΓΕΜΗ: 000823401000 | Ίδρυση: Νοέμβριος 1987"
    ...
    assert r2_afm_gemh_inDate == "ΑΦΜ: 094006864 | ΓΕΜΗ: 121545307000 | Ίδρυση: Σεπτέμβριος 1930"
    ...
    assert r3_afm_gemh_inDate == "ΑΦΜ: 801354084 | ΓΕΜΗ: 154983342000 | Ίδρυση: Ιούνιος 2020"
    ...
    assert r4_afm_gemh_inDate == "ΑΦΜ: 095483297 | ΓΕΜΗ: 036400616000 | Ίδρυση: Φεβρουάριος 1990"
    ...
    assert r5_afm_gemh_inDate  == "ΑΦΜ: 998530738 | ΓΕΜΗ: 021159526000 | Ίδρυση: Ιούνιος 2007"
